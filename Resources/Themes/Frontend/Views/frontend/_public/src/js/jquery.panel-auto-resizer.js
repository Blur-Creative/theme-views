    ...
    $.plugin('swPanelAutoResizer', {
        ...
        getMaxHeight: function ($elements) {
            ...
            $elements.each(function(index, childElement) {
				...
				//if($(childElement).hasClass("panel--body") || $(childElement).hasClass("list--group") || $(childElement).hasClass("panel--footer")) {
					itemHeight = $(childElement).outerHeight();
				//}
        ...
        setHeight: function($elements, height) {
            ...
            $.each($elements, function(index, childElement) {
				console.log($(childElement).css("padding"));
				if($(childElement).css("padding")=='0px') {
					$(childElement).height(height + me.opts.paddingValue);
				} else {
			...
			*/
            ...
            $.each($elements, function(index, childElement) {
				$(childElement).outerHeight(height);
            });
