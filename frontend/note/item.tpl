			...
			<div class="note--info panel--td">
				...
				{block name="frontend_note_item_image"}
					<div class="note--image-container">
						...
						{block name="frontend_note_item_delete_image"}
							<a href="{url controller='note' action='delete' sDelete=$sBasketItem.id}" title="{"{s name='NoteLinkDelete'}{/s}"|escape}" class="btn is--danger btn-block is--small note--delete">
								<span class="icon-node icon-cross"></span>
							</a>
						{/block}
					</div>
				{/block}
